...
const games = {
    ...
    "20":{
        game: "tictactoe",
        responseMessage: "Bueno, quería aprovechar para decirte que lamento no haberte podido invitar a salir o a hacer otras cosas últimamente, pero debido a nuestros horarios apretados y mis gastos en transporte no he tenido una gran oportunidad 😔. Sin embargo, espero que sepas que te amo y que siempre lo haré, y que, a no más pueda, te lo compensaré de una forma u otra. Y quería proponerte algo :3, ¿qué te parece si cuando vuelvas planeamos una idea a thorpe park/ Winter Wonderland(si no esta cerrado) + ice skating que hace tiempo que no vamos :3 💗? se que yo ya he ido y la verdad es que la pase muy bien, pero el plan oroginal fue nuestro y ya viste que me puso muy triste no haber podido haber ido contigo, es mas por muy bien que la haya pasado todo el dia estuve pensando 'Ojala estuvieras aqui 😩🙏' asi que ya me diras que te parece mi amorcito 🎀"
    },
    "22":{
